...
export default function ActivitiesSection() {
  ...
  return (
    <div className="container" style={{ padding: 'var(--spacing-2xl) 0' }}>
      ...
      >
        <motion.div variants={itemVariants} style={{ display: 'flex', gap: '3rem', flexWrap: 'wrap', alignItems: 'center', marginBottom: '3rem' }}>
        ...
        <motion.section variants={itemVariants} className="glass-panel" style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.9), rgba(255,255,255,0.7))' }}>
