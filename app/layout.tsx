          ...
          <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                <a href="#" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '40px', height: '40px', backgroundColor: '#334155', borderRadius: '50%', color: 'white', textDecoration: 'none', transition: 'background-color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#1877F2'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#334155'} title="Facebook">
                ...
                <a href="https://www.youtube.com/Putholi" target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '40px', height: '40px', backgroundColor: '#334155', borderRadius: '50%', color: 'white', textDecoration: 'none', transition: 'background-color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#FF0000'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#334155'} title="YouTube">
                ...
                <a href="https://twitter.com/putholi_uthira" target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '40px', height: '40px', backgroundColor: '#334155', borderRadius: '50%', color: 'white', textDecoration: 'none', transition: 'background-color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#1DA1F2'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#334155'} title="Twitter">
